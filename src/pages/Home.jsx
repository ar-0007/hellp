    ...
    <section className="px-10 pt-16" id="section1">
      <div className="grid lg:grid-cols-2 items-center justify-items-center gap-5">
        <div className="order-1 lg:order-1 shadow-2xl">
          <img
            className="h-80 w-80 object-cover lg:w-[500px] lg:h-[500px] shadow-[0_2px_10px_4px_rgba(6,81,237,0.3)]"
            src="IMG.jpg"
            alt=""
          />
        </div>
        <div className="order-2 lg:order-2 flex flex-col justify-center gap-2 lg:items-start text-center sm:text-left ">
          ...
          <div className="flex items-center justify-center">
            <button
              className="text-lg md:text-xl text-[#00df9a] py-2 m-2 px-5 mt-10 hover:bg-black hover:border-[#00df9a]   border rounded-full shadow-[0_2px_10px_-1px_rgba(6,81,237,0.3)]"
