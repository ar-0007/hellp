                        ...
                        <div className="flex flex-wrap -mx-4 mb-18 items-center">
                            <div className="w-full lg:w-1/2 px-4 mb-8 lg:mb-0">
                                <div className="max-w-md">
                                    <h1 className='text-green-600 text-xl border shadow-[0_2px_10px_-1px_rgba(6,81,237,0.3)] w-fit p-3 rounded-full mb-2'>Testimonials</h1>
                        ...
                        <div className="overflow-hidden md:mt-12">
                            ...
                            >
                                <div ref={slide1Ref} className="flex-shrink-0 h-full w-full p-5">
                                    <div className="flex flex-wrap mb-16 lg:mb-12 items-center">
                                        <div className="relative w-full lg:w-1/2 pb-16 lg:pb-0 px-4 mb-12 lg:mb-0">
                                            ...
                                            <div className="max-w-sm">
                                                <h5 className="text-xl font-semibold  mb-10">Shopify Marketing</h5>
                                                ...
                                                <div className="flex items-center">
                                                    <div className="ml-4">
                                                        <span className=" text-xl text-green-600">Swiftship - Client</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="w-full lg:w-1/2 px-4">
                                            <div className="max-w-sm lg:mx-auto">
                                                <h5 className="text-xl font-semibold  mb-10">Impressive Partnership</h5>
                                                ...
                                                <div className="flex items-center">
                                                    <div className="ml-4">
                                                        <span className=" text-xl text-green-600">Neon Clothing - Client</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                ...
                                <div ref={slide2Ref} className="flex-shrink-0 h-full w-full p-5">
                                    <div className="flex flex-wrap mb-16 lg:mb-12 items-center">
                                        <div className="relative w-full lg:w-1/2 pb-16 lg:pb-0 px-4 mb-12 lg:mb-0">
                                            ...
                                            <div className="lg:hidden absolute bottom-0 left-1/2 transform -translate-x-1/2 h-px w-52 bg-gray-500"></div>
                                            <div className="max-w-sm">
                                                <h5 className="text-xl font-semibold  mb-10">Gardener Marketing</h5>
                                                ...
                                                <div className="flex items-center">
                                                    <div className="ml-4">
                                                        <span className="text-xl text-green-600">Happy Gardening - Client</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="w-full lg:w-1/2 px-4">
                                            <div className="max-w-sm lg:mx-auto">
                                                <h5 className="text-xl font-semibold  mb-10">Top-notch Assistance for Growth</h5>
                                                ...
                                                <div className="flex items-center">
                                                    <div className="ml-4">
                                                        <span className="text-xl text-green-600">Sparkz - Client</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div className="flex flex-wrap mb-16 lg:mb-12 items-center">
                                        <div className="relative w-full lg:w-1/2 pb-16 lg:pb-0 px-4 mb-12 lg:mb-0">
                                            ...
                                            <div className="max-w-sm">
                                                ...
                                                <div className="flex items-center">
                                                    <div className="ml-4">
                                                        <span className=" text-xl text-green-600">Eluxure Online - Client</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        <div className="w-full lg:w-1/2 px-4">
                                            <div className="max-w-sm lg:mx-auto">
                                                <h5 className="text-xl font-semibold  mb-10">Invaluable Collaboration</h5>
                                                ...
                                                <div className="flex items-center">
                                                    <div className="ml-4">
                                                        <span className=" text-xl text-green-600">Meer & MoWi - RaJ MaYo</span>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
