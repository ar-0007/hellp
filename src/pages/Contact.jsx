...
const Contact = () => {
    ...
    const apiKey = "c232a874-8782-4a4f-be20-ade4dc28c82a";


    const { submit: onSubmit } = useWeb3Forms({
        access_key: apiKey,
        settings: {
            from_name: "Meer Agency Portfolio",
    ...
    return (
        <section id="contact">
            <div className='flex flex-col justify-center items-center '>
                ...
                <p className=' text-sm md:text-center ml-2.5 md:mt-6 mt-2'>Let’s make something new, different and more meaningful or make<br />  thing more visual or conceptual</p>
            </div>


            <div class="max-w-5xl max-lg:max-w-3xl mx-auto  font-[sans-serif]">
                    ...
                    <div class=" rounded-lg p-6 h-full max-lg:order-1 bg-gray-800 ">
                        ...
                        <ul class="mt-16 space-y-8">
                            <li class="flex items-center">
                                ...
                                <a href=" " class="text-gray-500 text-sm  ml-4">
                                    farhanshokatali68@gmail.com
                                </a>
                            </li>
                            <li class="flex items-center">
                            ...
                            <li class="flex items-center">
                                ...
                                <a href=" " class="text-sm text-gray-500 ml-4">
                                    Arraiyan Raiwind Road Lahore Pakistan
                                </a>
                            </li>
                        </ul>
                    ...
                    <div class="p-4 lg:col-span-2">
                        <form onSubmit={handleSubmit(onSubmit)}>
                            ...
                            <div className='w-full  flex items-center justify-center'>
                                ...
                                <button
                                    type="submit"
                                    className={`w-fit my-5 py-3  px-6 rounded-md shadow-md text-white text-sm ${isSubmitting ? "bg-green-400" : "bg-green-600 hover:bg-green-700"
                                        }`}
                                >
